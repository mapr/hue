...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """
        This data migration creates a home directory and trash directory for all Hue users and maps any orphan documents
        ...
        for user in User.objects.all():
            ...
            home_dir, _ = Directory.objects.get_or_create(name='', owner=user)
            trash_dir, _ = Directory.objects.get_or_create(name='.Trash', owner=user, parent_directory=home_dir)
            # For any directories or documents that do not have a parent directory, assign it to home directory
            for doc in Document2.objects.documents(user).filter(parent_directory=None).exclude(id__in=[home_dir.id, trash_dir.id]):
    ...
    models = {
        ...
        u'desktop.document2': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a6a7637d-c626-4aa3-a7d7-770b23e987c1'", 'max_length': '36', 'db_index': 'True'}),
