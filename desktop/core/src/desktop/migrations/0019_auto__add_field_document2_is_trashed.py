...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document2.is_trashed'
        db.add_column(u'desktop_document2', 'is_trashed',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document2.is_trashed'
        db.delete_column(u'desktop_document2', 'is_trashed')
    ...
    models = {
        ...
        u'desktop.document2': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'cacf9bcb-ce31-49c7-b0dc-1ee4816a56b0'", 'max_length': '36', 'db_index': 'True'}),
