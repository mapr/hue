...
SSL_CACERTS = Config(
  ...
  type=str,
  default='/opt/mapr/hue/hue-3.12.0/keys/cert.pem')
...
DEFAULT_JOBTRACKER_HOST = Config(
    ...
    help=_(
        "This should be the currently active job tracker IP @, default to maprfs:/// will let JobClient find it automatically"),
    type=str,
    default="maprfs:///")
