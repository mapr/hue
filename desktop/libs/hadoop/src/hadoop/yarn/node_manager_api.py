...
def get_node_manager_api(api_url):
  ...
  return NodeManagerApi(api_url, yarn_cluster.SECURITY_ENABLED.get(), yarn_cluster.SSL_CERT_CA_VERIFY.get(), yarn_cluster.MECHANISM.get())


class NodeManagerApi(object):
  def __init__(self, oozie_url, security_enabled=False, ssl_cert_ca_verify=True, mechanism='none'):
