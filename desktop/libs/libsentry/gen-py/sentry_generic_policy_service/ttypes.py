...
class TSentryPrivilege(object):
    ...
    def __init__(self, component=None, serviceName=None, authorizables=None, action=None, createTime=None, grantorPrincipal=None, grantOption=0,):
    ...
    def validate(self):
        ...
        if self.authorizables is None:
            raise TProtocolException(message='Required field authorizables is unset!')
...
class TCreateSentryRoleRequest(object):
    ...
    def __init__(self, protocol_version=2, requestorUserName=None, roleName=None, component=None,):
...
class TAlterSentryRoleAddGroupsRequest(object):
    ...
    def __init__(self, protocol_version=2, requestorUserName=None, roleName=None, component=None, groups=None,):
        self.protocol_version = protocol_version
        self.requestorUserName = requestorUserName
        self.roleName = roleName
        self.component = component
...
class TAlterSentryRoleGrantPrivilegeRequest(object):
    ...
    def __init__(self, protocol_version=2, requestorUserName=None, roleName=None, component=None, privilege=None,):
        self.protocol_version = protocol_version
        self.requestorUserName = requestorUserName
        self.roleName = roleName
        self.component = component
...
class TListSentryRolesRequest(object):
    ...
    def __init__(self, protocol_version=2, requestorUserName=None, groupName=None, component=None,):
        self.protocol_version = protocol_version
        self.requestorUserName = requestorUserName
...
class TListSentryPrivilegesRequest(object):
    ...
    def __init__(self, protocol_version=2, requestorUserName=None, roleName=None, component=None, serviceName=None, authorizables=None,):
        self.protocol_version = protocol_version
        self.requestorUserName = requestorUserName
        self.roleName = roleName
        self.component = component
...
class TDropPrivilegesRequest(object):
    ...
    def __init__(self, protocol_version=2, requestorUserName=None, privilege=None, component=None,):
        self.protocol_version = protocol_version
        self.requestorUserName = requestorUserName
        self.privilege = privilege
        self.component = component
...
class TRenamePrivilegesRequest(object):
    ...
    def __init__(self, protocol_version=2, requestorUserName=None, component=None, serviceName=None, oldAuthorizables=None, newAuthorizables=None,):
        self.protocol_version = protocol_version
        self.requestorUserName = requestorUserName
        self.component = component
        self.serviceName = serviceName
    ...
    def validate(self):
        ...
        if self.oldAuthorizables is None:
            raise TProtocolException(message='Required field oldAuthorizables is unset!')
        if self.newAuthorizables is None:
            raise TProtocolException(message='Required field newAuthorizables is unset!')
        return
...
class TListSentryPrivilegesForProviderRequest(object):
    ...
    def __init__(self, protocol_version=2, component=None, serviceName=None, groups=None, roleSet=None, authorizables=None,):
        self.protocol_version = protocol_version
        self.component = component
        self.serviceName = serviceName
        self.groups = groups
...
class TListSentryPrivilegesByAuthRequest(object):
    ...
    def __init__(self, protocol_version=2, requestorUserName=None, component=None, serviceName=None, authorizablesSet=None, groups=None, roleSet=None,):
        self.protocol_version = protocol_version
        self.requestorUserName = requestorUserName
        self.component = component
        self.serviceName = serviceName
    ...
    def validate(self):
        ...
        if self.authorizablesSet is None:
            raise TProtocolException(message='Required field authorizablesSet is unset!')
        return
...
class TListSentryPrivilegesByAuthResponse(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(TAuthorizable)
TAuthorizable.thrift_spec = (
    None,  # 0
...
TSentryPrivilege.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'component', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'serviceName', 'UTF8', None, ),  # 2
    (3, TType.LIST, 'authorizables', (TType.STRUCT, [TAuthorizable, None], False), None, ),  # 3
    (4, TType.STRING, 'action', 'UTF8', None, ),  # 4
    (5, TType.I64, 'createTime', None, None, ),  # 5
    (6, TType.STRING, 'grantorPrincipal', 'UTF8', None, ),  # 6
...
TCreateSentryRoleRequest.thrift_spec = (
    ...
    (4, TType.STRING, 'component', 'UTF8', None, ),  # 4
)
...
TAlterSentryRoleAddGroupsRequest.thrift_spec = (
    ...
    (3, TType.STRING, 'roleName', 'UTF8', None, ),  # 3
    (4, TType.STRING, 'component', 'UTF8', None, ),  # 4
    (5, TType.SET, 'groups', (TType.STRING, 'UTF8', False), None, ),  # 5
)
...
TListSentryPrivilegesRequest.thrift_spec = (
    ...
    (6, TType.LIST, 'authorizables', (TType.STRUCT, [TAuthorizable, None], False), None, ),  # 6
)
...
TDropPrivilegesRequest.thrift_spec = (
    ...
    (1, TType.I32, 'protocol_version', None, 2, ),  # 1
    (2, TType.STRING, 'requestorUserName', 'UTF8', None, ),  # 2
    (3, TType.STRUCT, 'privilege', [TSentryPrivilege, None], None, ),  # 3
    (4, TType.STRING, 'component', 'UTF8', None, ),  # 4
)
...
TRenamePrivilegesRequest.thrift_spec = (
    ...
    (1, TType.I32, 'protocol_version', None, 2, ),  # 1
    (2, TType.STRING, 'requestorUserName', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'component', 'UTF8', None, ),  # 3
    (4, TType.STRING, 'serviceName', 'UTF8', None, ),  # 4
    (5, TType.LIST, 'oldAuthorizables', (TType.STRUCT, [TAuthorizable, None], False), None, ),  # 5
    (6, TType.LIST, 'newAuthorizables', (TType.STRUCT, [TAuthorizable, None], False), None, ),  # 6
)
...
TListSentryPrivilegesByAuthRequest.thrift_spec = (
    ...
    (3, TType.STRING, 'component', 'UTF8', None, ),  # 3
    (4, TType.STRING, 'serviceName', 'UTF8', None, ),  # 4
    (5, TType.SET, 'authorizablesSet', (TType.STRING, 'UTF8', False), None, ),  # 5
    (6, TType.SET, 'groups', (TType.STRING, 'UTF8', False), None, ),  # 6
    (7, TType.STRUCT, 'roleSet', [TSentryActiveRoleSet, None], None, ),  # 7
)
all_structs.append(TListSentryPrivilegesByAuthResponse)
TListSentryPrivilegesByAuthResponse.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'status', [sentry_common_service.ttypes.TSentryResponseStatus, None], None, ),  # 1
    (2, TType.MAP, 'privilegesMapByAuth', (TType.STRING, 'UTF8', TType.STRUCT, [TSentryPrivilegeMap, None], False), None, ),  # 2
)
