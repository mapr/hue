...
class Processor(Iface, TProcessor):
    ...
    def process_isMappingEnable(self, seqid, iprot, oprot):
        ...
        try:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("isMappingEnable", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_getTableNamesByPath(self, seqid, iprot, oprot):
        ...
        try:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("getTableNamesByPath", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class isMappingEnable_args(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(isMappingEnable_args)
isMappingEnable_args.thrift_spec = (
)


class isMappingEnable_result(object):
    """
    Attributes:
     - success
     - io
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(isMappingEnable_result)
isMappingEnable_result.thrift_spec = (
    (0, TType.BOOL, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'io', [IOError, None], None, ),  # 1
)
...
class getTableNamesByPath_args(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getTableNamesByPath_args)
getTableNamesByPath_args.thrift_spec = (
    None,  # 0
...
class getTableNamesByPath_result(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getTableNamesByPath_result)
getTableNamesByPath_result.thrift_spec = (
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter88, viter89 in self.attributes.items():
                oprot.writeBinary(kiter88)
                oprot.writeBinary(viter89)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter104, viter105 in self.attributes.items():
                oprot.writeBinary(kiter104)
                oprot.writeBinary(viter105)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter120, viter121 in self.attributes.items():
                oprot.writeBinary(kiter120)
                oprot.writeBinary(viter121)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter136, viter137 in self.attributes.items():
                oprot.writeBinary(kiter136)
                oprot.writeBinary(viter137)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter159, viter160 in self.attributes.items():
                oprot.writeBinary(kiter159)
                oprot.writeBinary(viter160)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter175, viter176 in self.attributes.items():
                oprot.writeBinary(kiter175)
                oprot.writeBinary(viter176)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i194 in range(_size190):
                        _key195 = iprot.readBinary()
                        _val196 = iprot.readBinary()
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter198, viter199 in self.attributes.items():
                oprot.writeBinary(kiter198)
                oprot.writeBinary(viter199)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter221, viter222 in self.attributes.items():
                oprot.writeBinary(kiter221)
                oprot.writeBinary(viter222)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter251, viter252 in self.attributes.items():
                oprot.writeBinary(kiter251)
                oprot.writeBinary(viter252)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter274, viter275 in self.attributes.items():
                oprot.writeBinary(kiter274)
                oprot.writeBinary(viter275)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter304, viter305 in self.attributes.items():
                oprot.writeBinary(kiter304)
                oprot.writeBinary(viter305)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i323 in range(_size319):
                        _key324 = iprot.readBinary()
                        _val325 = iprot.readBinary()
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter343, viter344 in self.attributes.items():
                oprot.writeBinary(kiter343)
                oprot.writeBinary(viter344)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter359, viter360 in self.attributes.items():
                oprot.writeBinary(kiter359)
                oprot.writeBinary(viter360)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter375, viter376 in self.attributes.items():
                oprot.writeBinary(kiter375)
                oprot.writeBinary(viter376)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter384, viter385 in self.attributes.items():
                oprot.writeBinary(kiter384)
                oprot.writeBinary(viter385)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter393, viter394 in self.attributes.items():
                oprot.writeBinary(kiter393)
                oprot.writeBinary(viter394)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter402, viter403 in self.attributes.items():
                oprot.writeBinary(kiter402)
                oprot.writeBinary(viter403)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter418, viter419 in self.attributes.items():
                oprot.writeBinary(kiter418)
                oprot.writeBinary(viter419)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter427, viter428 in self.attributes.items():
                oprot.writeBinary(kiter427)
                oprot.writeBinary(viter428)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter443, viter444 in self.attributes.items():
                oprot.writeBinary(kiter443)
                oprot.writeBinary(viter444)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i455 in range(_size451):
                        _key456 = iprot.readBinary()
                        _val457 = iprot.readBinary()
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter459, viter460 in self.attributes.items():
                oprot.writeBinary(kiter459)
                oprot.writeBinary(viter460)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter475, viter476 in self.attributes.items():
                oprot.writeBinary(kiter475)
                oprot.writeBinary(viter476)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i487 in range(_size483):
                        _key488 = iprot.readBinary()
                        _val489 = iprot.readBinary()
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter491, viter492 in self.attributes.items():
                oprot.writeBinary(kiter491)
                oprot.writeBinary(viter492)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter507, viter508 in self.attributes.items():
                oprot.writeBinary(kiter507)
                oprot.writeBinary(viter508)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter544, viter545 in self.attributes.items():
                oprot.writeBinary(kiter544)
                oprot.writeBinary(viter545)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
