...
<script id="edit-app" type="text/html">
  ...
  <div class="card card-small" style="padding-bottom: 68px;">
    ...
    <!-- /ko -->
    <div class="margin-top-20" data-bind="visible: availableGroups().length > 0">
      <select data-bind="options: availableGroups, optionsText: 'name', optionsCaption: 'Add group override...', value: groupToAdd"></select>
    ...
    ConfigurationsViewModel.prototype.updateFromData = function (data) {
      ...
      $.each(data.configuration, function (appName, app) {
        ...
        app.default.forEach(function (defaultProperty) {
          defaultProperty.defaultValue = propertyIndex[defaultProperty.name].value;
        ...
        if (typeof app.groups === 'undefined') {
          ...
          $.each(app.groups, function (groupId, groupValues) {
            ...
            groupValues.forEach(function (groupValue) {
              groupValue.defaultValue = propertyIndex[groupValue.name].value;
