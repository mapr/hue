                  ...
                  <li class="white paramContainer">
                    ...
                    <div class="param">
                      ...
                      <div data-bind="css: {'error': $root.getSettingKeyErrors($index()).length > 0}" class="control-group">
                        <label>${_('Key')}</label>
                        <input data-bind="value: key" type="text" class="settingsField" autocomplete="off" placeholder="${ 'impala.resultset.cache.size' if app_name == 'impala' else 'mapred.reduce.tasks' }" style="width: 100%; box-sizing: border-box;" />
                      </div>

                      <div data-bind="css: {'error': $root.getSettingValueErrors($index()).length > 0}" class="control-group">
                        <label>${_('Value')}</label>
                        <input data-bind="value: value" type="text" class="settingValuesField" placeholder="${ '5000' if app_name == 'impala' else '1' }" style="width: 100%; box-sizing: border-box;" />
                      </div>
                    </div>
                    <!-- /ko -->
                  ...
                  <li class="white paramContainer
                    ...
                    <div class="param">
                      ...
                      <div data-bind="css: {'error': $root.getFileResourcePathErrors($index()).length > 0}" class="control-group">
                        <label>${_('Path')}</label>
                        <input data-bind="value: path" type="text" class="filesField fileChooser" placeholder="/user/foo/udf.jar" style="width: 100%; box-sizing: border-box; margin-right: -26px;" />
                      </div>
                    </div>
                    <!-- /ko -->
                  ...
                  <li class="white paramContainer
                    ...
                    <div class="param">
                      ...
                      <div data-bind="css: {'error': $root.getFunctionNameErrors($index()).length > 0}" class="control-group">
                        <label>${_('Name')}</label>
                        <input data-bind="value: name" type="text" class="functionsField" autocomplete="off" placeholder="myFunction" style="width: 100%; box-sizing: border-box;" />
                      </div>

                      <div data-bind="css: {'error': $root.getFunctionClassNameErrors($index()).length > 0}" class="control-group">
                        <label>${_('Class name')}</label>
                        <input data-bind="value: class_name" type="text" class="classNamesField" placeholder="com.acme.example" style="width: 100%; box-sizing: border-box;" />
                      </div>
                    </div>
                    <!-- /ko -->
