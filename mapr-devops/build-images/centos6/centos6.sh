...
cp -v /tmp/setupfiles/RPM-GPG-KEY-EPEL-6 /etc/pki/rpm-gpg/.
cp -v /tmp/setupfiles/epel.repo /etc/yum.repos.d/.
...
/tmp/cross-linux/java7-install.sh
cp -fv /tmp/cross-linux/java7-profile.sh /etc/profile.d/.
